...
$req="SELECT * FROM products WHERE categorie='Accessories'";
...
<header class="header">
    ...
    <section class="men">
        <div class="container">
            <div class="men-item">
                <img src="image/aa3.png" alt="Image 1">
            </div>
            <div class="men-item">
                <div class="overlay">
                    <img src="image/aa1.png" alt="Image 2">
                </div>
            </div>
            <div class="men-item">
                <div class="overlay">
                    <img src="image/aa2.png" alt="Image 3">
                </div>
            </div>
            <div class="men-item">
                <img src="image/aa4.png" alt="Image 4">
            </div>
        </div>
    </section> 
