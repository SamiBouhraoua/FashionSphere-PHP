...
$req="SELECT * FROM products WHERE categorie='men'";
...
<header class="header">
    ...
    <section class="men">
        <div class="container">
            <div class="men-item">
                <img src="image/m4.png" alt="Image 1">
            </div>
            <div class="men-item">
                <div class="overlay">
                    <h2>Mens</h2>
                    <img src="image/m1.png" alt="Image 2">
                </div>
            </div>
            <div class="men-item">
                <div class="overlay">
                    <h2>Wear</h2>
                    <img src="image/m2.png" alt="Image 3">
                </div>
            </div>
            <div class="men-item">
                <img src="image/m3.png" alt="Image 4">
            </div>
        </div>
    </section>  
