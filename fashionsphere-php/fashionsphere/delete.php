...
if (isset($_POST['confirm'])) {
    $req = "DELETE FROM products WHERE id = $product_id";
...
<body>
    ...
    <div class="confirmation-message">
        <p>Êtes-vous sûr de vouloir supprimer le produit "<strong><?php echo $product_Titre; ?></strong>" ?</p>
        <form action="delete.php?id=<?php echo $product_id; ?>" method="post">
            ...
            <a href="products.php" class="btn btn-cancel">Non, annuler</a>
        </form>
    </div>
